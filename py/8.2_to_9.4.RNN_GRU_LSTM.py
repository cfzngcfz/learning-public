...
num_hiddens = 256
num_layers = 2
lstm_layer = nn.LSTM(num_inputs, num_hiddens) # 简单 LSTM
# lstm_layer = nn.LSTM(num_inputs, num_hiddens, num_layers) # 深度 LSTM
# lstm_layer = nn.LSTM(num_inputs, num_hiddens, num_layers, bidirectional=True) # 双向 LSTM
